...
pub trait Table: Send + Sync {
    ...
    // put
    fn insert(&self, process: &mut Process, value: Term, key_clash_fail: bool) -> Result<()>; /* DB_ERROR_BADKEY if key exists */
    ...
    // int (*db_select_chunk)(process: &mut Process, table: &Self, Eterm tid, Eterm pattern, Sint chunk_size, int reverse, Eterm* ret);
    ...
    // fn lookup_dbterm(&self, process: &mut Process, key: Term, obj: Term) -> DbUpdateHandle;
